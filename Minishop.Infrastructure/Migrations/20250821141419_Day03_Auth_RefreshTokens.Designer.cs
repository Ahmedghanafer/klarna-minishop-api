...
namespace Minishop.Infrastructure.Migrations
{
    ...
    [Migration("20250821141419_Day03_Auth_RefreshTokens")]
    partial class Day03_Auth_RefreshTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Minishop.Core.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Minishop.Core.Entities.RefreshToken", b =>
                {
                    b.HasOne("Minishop.Core.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
